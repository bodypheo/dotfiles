...
our $SCHEMA = [
    ...
    {item => ['xdg-open http:',    'Web Browser',       'internet']},
    {pipe => ['~/.dotfiles/cbpp-pipemenus/cbpp-pipemenus/data/usr/bin/cbpp-recent-files-pipemenu',    'Archivos recientes',       'emblem-documents']},
    {pipe => ['~/.dotfiles/cbpp-pipemenus/cbpp-pipemenus/data/usr/bin/cbpp-places-pipemenu',    'Home Sweet Hell',       'folder']},
	{begin_cat => ['Capturar Pantalla', 'camera']},
		{item => ['scrot "%Y-%m-%d--%s_$wx$h_scrot.png" -e "mv $f ~/Imágenes/ &amp; viewnior ~/Imágenes/$f"', 'Ahora']},
		{item => ['scrot -d 5 "%Y-%m-%d--%s_$wx$h_scrot.png" -e "mv $f ~/Imágenes/ &amp; viewnior ~/Imágenes/$f"', 'En 5 segundos...']},
		{item => ['scrot -d 10 "%Y-%m-%d--%s_$wx$h_scrot.png" -e "mv $f ~/Imágenes/ &amp; viewnior ~/Imágenes/$f"', 'En 10 segundos...']},
		{item => ['scrot -s "%Y-%m-%d--%s_$wx$h_scrot.png" -e "mv $f ~/Imágenes/ &amp; viewnior ~/Imágenes/$f"', 'Seleccionar Área ...']},
		{item => ['scrot -u "%Y-%m-%d--%s_$wx$h_scrot.png" -e "mv $f ~/Imágenes/ &amp; viewnior ~/Imágenes/$f"', 'Ventana actual ...']},
	{end_cat => undef},
